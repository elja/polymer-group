...
Refinery::Pages.configure do |config|
  ...
  config.types.register :home do |home|
    home.parts = %w[body right_column bottom_body splash]
  end

  config.types.register :contacts do |contacts|
    contacts.parts = %w[body right_column bottom_body splash]
  end

  config.types.register :show do |contacts|
    contacts.parts = %w[body]
  end

  # Configure global page default parts
  config.default_parts = ["Body", "Right Column", "Bottom Body", "Splash"]
  ...
  config.layout_template_whitelist = ["default", "2_column_right"]
